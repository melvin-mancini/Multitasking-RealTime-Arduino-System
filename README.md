...
After installing ARTe and implementing the circuit, you can connect the Arduino to the PC and wait for the software to recognize the device. Then, through the Arduino editor with ARTe, you should open the src.ino file located in the src folder of the project. You must enable ARTe as explained in the previous section [ARTe installation](#ciao) and then you can complete the project and upload it to the Arduino board.
