...
#
ifndef MPARM_DIR
MPARM_DIR=/cygdrive/c/Evidence/Evidence/mparm
endif
...
mparm.elf: $(OBJS) $(THUMB_OBJS) $(LINKDEP) $(LIBDEP)
	@printf "LD\n";
...
loc_gnu.ld: $(PKGBASE)/board/unibo_mparm/cfg/loc_gnu.ld
	@printf "LOC\n" ;
	@cp $(PKGBASE)/board/unibo_mparm/cfg/loc_gnu.ld .

loc_mparm.ld: cfg_e7t.h
	@printf "AWK\n" ;
	@awk '/#define/{ print $$2 " = " $$3 ";" }' < cfg_e7t.h >loc_mparm.ld
