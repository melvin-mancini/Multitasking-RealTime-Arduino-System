...
OPT_CC += -march=armv7-m -mcpu=cortex-m3 -mthumb -mthumb-interwork 
endif
...
# Arduino support
ifeq ($(call iseeopt, __RTD_ARDUINO__), yes)
OPT_CC += -funsigned-char -funsigned-bitfields -fpack-struct -fshort-enums
endif
...
OPT_ASM += -march=armv7-m -mcpu=cortex-m3 -mthumb -mthumb-interwork 
endif
...
# Arduino support
ifeq ($(call iseeopt, __RTD_ARDUINO__), yes)
OPT_ASM += -funsigned-char -funsigned-bitfields -fpack-struct -fshort-enums
endif
...
# MM: global or per-application? 
#OPT_LINK += -lnosys -lc -lgcc --specs=rdimon.specs -lrdimon
#OPT_LINK += -lnosys -lc -lgcc

# Define HW architecture
ifeq ($(call iseeopt, __CORTEX_M3__), yes)
# MM: Check!!!
\OPT_LINK += -march=armv7-m -mcpu=cortex-m3 -mthumb -mthumb-interwork 
endif
