...
#ifdef __ISO15765__
/* Defines the callbacks used by the underlying network layer */
#define EE_COM_SET_CALLOUT(FF_INDICATION) EE_N_SET_CALLOUT(FF_INDICATION,EE_COM_get_ipdu,EE_COM_confirm)
#endif
#endif
